# -*- coding: utf-8 -*-
#-------------------------------------------------------------------------------
# Name:        izosapi_application_methods.py
# Purpose:     store custom methods for wrapper class of IZOSAPI_Application
# Licence:     MIT License
#-------------------------------------------------------------------------------
"""Store custom methods for wrapper class of IZOSAPI_Application.
